...
`@script`
Let's go through a a few interview examples together. You are presented with a database with two tables in it. The SALES table has 10 rows of data, and each row represents a unique sale made by the company. It has a contact_id column to identify the customer who made the purchase.
...
- Not all of of your company's contacts may have made a purchase.
 ![Contacts Table](https://github.com/bld2104/datacamp-10-sql-interview-questions/blob/master/course_Images/contacts_table_new.png?raw=true)
...
_(This is easier with smaller datasets.)_
 ...
 ![Contacts Left Table JOIN](contacts_left_table)
...
![Sales Left Table JOIN](sales_left_table)
